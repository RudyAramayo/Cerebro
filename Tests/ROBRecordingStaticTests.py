...
require(lidar, "recordLidarScanData", "valid binary lidar scans are not recorded")
require(coordinator, '"scan_encoding": "rob-lidar-scan-binary-v1"', "binary lidar encoding is not recorded")
