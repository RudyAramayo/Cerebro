...
class HumanBodySkeletonRenderer: NSObject {
    ...
    func createInputImage2DNode(image: NSImage?) -> SCNNode {
        // The SceneKit nodes.
    ...
    func imageWithExifOrientationApplied(_ image: NSImage) -> NSImage {
...
//        return orientedImage ?? image
    ...
    func createCameraPyramidNode(observation: VNHumanBodyPose3DObservation) -> SCNNode {
        ...
        originCameraNode.geometry?.firstMaterial?.diffuse.contents = NSColor(ciColor:.cyan)
