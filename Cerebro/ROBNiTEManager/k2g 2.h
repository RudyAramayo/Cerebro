...
public:
	...
	K2G(Processor p = OPENGL, bool mirror = true, std::string serial = std::string()): mirror_(mirror), listener_(libfreenect2::Frame::Color | libfreenect2::Frame::Ir | libfreenect2::Frame::Depth),
