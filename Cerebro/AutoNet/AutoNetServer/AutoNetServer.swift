...
@objcMembers public class AutoNetServer: NSObject {
    ...
    public init(service:String, port:UInt16, dataDelegate:AutoNetServerDataDelegate?) {
        ...
        tcp_options.keepaliveIdle = 1
        tcp_options.keepaliveCount = 10
        tcp_options.enableFastOpen = true
        tcp_options.disableECN = true
        tcp_options.disableAckStretching = true
        ...
        listener = try! NWListener(using: udp_parameters)
